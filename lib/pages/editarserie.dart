      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            TextBoxCadastrar(campo: "Ano:", getText: _getAno, mask: maskAno, value: widget.series.Ano),
            TextBoxCadastrar(campo: "Numero de Temporadas:", getText: _getNumeroTemporada, mask: maskData, value: widget.series.NumeroTemporada),
            TextBoxCadastrar(campo: "Ano:", getText: _getAno, mask: maskAno, value: widget.series.AnoFim),
            TextBoxCadastrar(campo: "Gênero:", getText: _getGenero, mask: null, value: widget.series.Generos.map((e) => e.Gen).join(",").toString()),

  ...
  Widget build(BuildContext context){
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text("Filmes", style: TextStyle(color: Colors.deepOrange),), backgroundColor: Colors.black,
        ),
        /*drawer: Drawer(
          child: Column(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment
                                          .start,
                                      children: [
                                        Text("Titulo : ${widget.filmes[index]
                                            .Titulo}", style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 20,),),
                                        Text("Sinopse : ${widget.filmes[index]
                                            .Sinopse}", style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 15,
                                            color: Colors.white),),
                                        Text("Data de Lancamento : ${widget
                                          ...
                                          style: TextStyle(
                                              ...
                                              color: Colors.white),),
                                        Text(
                                          "Ano : ${widget.filmes[index].Ano}",
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              fontSize: 15,
                                              color: Colors.white),),
                                        Text("Genero : ${widget.filmes[index]
                                            .Generos.map((e) => e.Gen)
                                            .join(",")}",
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
